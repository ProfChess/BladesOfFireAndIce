...
public class EnemyAISettings : ScriptableObject
{
    ...
    [Tooltip("Distance The Enemy Can go From Where They Spawned Without Returning Home When Set to Point")]
    public float LeashRange = 0f;
    [Tooltip("Distance The Enemy Can go Outside Their Room When Set to Room Type")]
    public int RoomLeashPadding = 0;
